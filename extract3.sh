...
CONFIG_FILE=/auto/phd/09/igor/mmdetection/configs/i2102/210218JPG_MM4G1_Pretrained_UNetResNet50.py
CHECKPOINT=/tmp2/igor/checkpoints/S_PUR50_epoch_126.pth
CUDA_VISIBLE_DEVICES=$GPU_ID python extract.py ${CONFIG_FILE} ${CHECKPOINT} /tmp2/igor/LL-tSNE/testset_resized/ --output_dir=${EXPERIMENT_DIR}/features_testset --samples_per_gpu=1 --feature_level=2 --part=unet --downsample=4
