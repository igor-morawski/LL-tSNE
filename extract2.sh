...
CONFIG_FILE=/auto/phd/09/igor/mmdetection/configs/i2102/210218JPG_MM4G1_ResNet50.py
CHECKPOINT=/tmp2/igor/checkpoints/COCO_R50_epoch_1.pth
CUDA_VISIBLE_DEVICES=$GPU_ID python extract.py ${CONFIG_FILE} ${CHECKPOINT} /tmp2/igor/LL-tSNE/testset_resized/ --output_dir=${EXPERIMENT_DIR}/features_testset --samples_per_gpu=8 --feature_level=0  --downsample=2
...
CUDA_VISIBLE_DEVICES=$GPU_ID python extract.py ${CONFIG_FILE} ${CHECKPOINT} /tmp2/igor/LL-tSNE/testset_resized/ --output_dir=${EXPERIMENT_DIR}/features_testset --samples_per_gpu=2 --feature_level=0 --downsample=2
